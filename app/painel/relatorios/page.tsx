...
const ReportPage = () => (
  <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-md text-center">
    ...
    <p className="text-xl font-medium text-gray-600 mb-6">Estamos trabalhando na melhoria dessa funcionalidade.</p>
    <p className="text-gray-500 mb-8">Desculpe o transtorno. Por favor, tente novamente mais tarde.</p>
    <Link
